...
export type StoriesQuery = { __typename?: 'Query', stories: Array<{ __typename?: 'Story', id: number, title: string, image: string, price?: number | null, userStory?: { __typename?: 'UserStory', type?: UserStoryType | null } | null }>, storiesCount: { __typename?: 'AggregateCountOutput', count: number } };
...
export type StoryQuery = { __typename?: 'Query', story: { __typename?: 'Story', authorId: string, createdAt: any, id: number, image: string, price?: number | null, description: string, title: string, updatedAt: any, author?: { __typename?: 'User', uid: string, name?: string | null } | null, startingNodes?: Array<{ __typename?: 'Node', title: string, id: number }> | null, userStory?: { __typename?: 'UserStory', type?: UserStoryType | null } | null, nodes?: Array<{ __typename?: 'Node', id: number, image?: string | null, end?: boolean | null, start?: boolean | null, title: string, content: string }> | null } };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoginOutput', refreshToken: string, localId: string, kind: string, idToken: string, expiresIn: string, email: string, displayName: string } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'RegisterOutput', refreshToken: string, localId: string, kind: string, idToken: string, expiresIn: string, email: string, displayName: string } };
...
export type CreateNodesMutation = { __typename?: 'Mutation', createNodes: Array<{ __typename?: 'Node', id: number }> };

export type NodesQueryVariables = Exact<{
  where?: InputMaybe<NodeWhereInput>;
  orderBy?: InputMaybe<Array<NodeOrderByWithRelationInput> | NodeOrderByWithRelationInput>;
  cursor?: InputMaybe<NodeWhereUniqueInput>;
  take?: InputMaybe<Scalars['Int']>;
  skip?: InputMaybe<Scalars['Int']>;
...
export type NodesQuery = { __typename?: 'Query', nodes: Array<{ __typename?: 'Node', id: number, title: string, image?: string | null, end?: boolean | null, start?: boolean | null, storyId: number, content: string, choiceNodes?: Array<{ __typename?: 'Choice', id: number, choiceText: string, choiceNode: { __typename?: 'Node', id: number, title: string } }> | null }>, nodesCount: { __typename?: 'AggregateCountOutput', count: number } };
...
export type CreateManyChoicesMutation = { __typename?: 'Mutation', createManyChoices: Array<{ __typename?: 'Choice', id: number }> };

export type ChoicesQueryVariables = Exact<{
  where?: InputMaybe<ChoiceWhereInput>;
  orderBy?: InputMaybe<Array<ChoiceOrderByWithRelationInput> | ChoiceOrderByWithRelationInput>;
  cursor?: InputMaybe<ChoiceWhereUniqueInput>;
  take?: InputMaybe<Scalars['Int']>;
  skip?: InputMaybe<Scalars['Int']>;
...
export type ChoicesQuery = { __typename?: 'Query', choices: Array<{ __typename?: 'Choice', id: number, choiceText: string, choiceNode: { __typename?: 'Node', id: number, title: string } }> };
...
export type CreateUserStoryMutation = { __typename?: 'Mutation', createUserStory: { __typename?: 'UserStory', type?: UserStoryType | null } };
...
export type RemoveUserStoryMutation = { __typename?: 'Mutation', removeUserStory: { __typename?: 'UserStory', uid: string, storyId: number } };

export type UserStoriesQueryVariables = Exact<{
  uid: Scalars['String'];
  distinct?: InputMaybe<Array<UserStoryScalarFieldEnum> | UserStoryScalarFieldEnum>;
  skip?: InputMaybe<Scalars['Int']>;
  take?: InputMaybe<Scalars['Int']>;
  cursor?: InputMaybe<UserStoryWhereUniqueInput>;
  orderBy?: InputMaybe<Array<UserStoryOrderByWithRelationInput> | UserStoryOrderByWithRelationInput>;
  where?: InputMaybe<UserStoryWhereInput>;
}>;


export type UserStoriesQuery = { __typename?: 'Query', userStories: Array<{ __typename?: 'UserStory', createdAt: any, type?: UserStoryType | null, story: { __typename?: 'Story', image: string, price?: number | null, title: string, id: number } }>, userStoriesCount: { __typename?: 'AggregateCountOutput', count: number } };
...
export type UserStoriesCountQuery = { __typename?: 'Query', userStoriesCount: { __typename?: 'AggregateCountOutput', count: number } };
...
export type UserStoryQuery = { __typename?: 'Query', userStory: { __typename?: 'UserStory', uid: string, type?: UserStoryType | null } };
...
export const StoriesDocument = /*#__PURE__*/ gql`
    query stories($where: StoryWhereInput, $orderBy: [StoryOrderByWithRelationInput!], $cursor: StoryWhereUniqueInput, $take: Int, $skip: Int, $distinct: [StoryScalarFieldEnum!], $searchTerm: String) {
  stories(
    where: $where
    orderBy: $orderBy
    cursor: $cursor
...
export const CreateNodesDocument = /*#__PURE__*/ gql`
  ...
  createNodes(CreateMultipleNodesInput: $createMultipleNodesInput) {
    ...
    `;
export type CreateNodesMutationFn = Apollo.MutationFunction<CreateNodesMutation, CreateNodesMutationVariables>;
 ...
 * });
 */
export function useCreateNodesMutation(baseOptions?: Apollo.MutationHookOptions<CreateNodesMutation, CreateNodesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateNodesMutation, CreateNodesMutationVariables>(CreateNodesDocument, options);
      }
export type CreateNodesMutationHookResult = ReturnType<typeof useCreateNodesMutation>;
export type CreateNodesMutationResult = Apollo.MutationResult<CreateNodesMutation>;
export type CreateNodesMutationOptions = Apollo.BaseMutationOptions<CreateNodesMutation, CreateNodesMutationVariables>;
export const NodesDocument = /*#__PURE__*/ gql`
    query nodes($where: NodeWhereInput, $orderBy: [NodeOrderByWithRelationInput!], $cursor: NodeWhereUniqueInput, $take: Int, $skip: Int, $distinct: [NodeScalarFieldEnum!]) {
  nodes(
    where: $where
    orderBy: $orderBy
    cursor: $cursor
...
export const CreateManyChoicesDocument = /*#__PURE__*/ gql`
  ...
  createManyChoices(createManyChoiceInput: $createManyChoiceInput) {
    ...
    `;
export type CreateManyChoicesMutationFn = Apollo.MutationFunction<CreateManyChoicesMutation, CreateManyChoicesMutationVariables>;
 ...
 * });
 */
export function useCreateManyChoicesMutation(baseOptions?: Apollo.MutationHookOptions<CreateManyChoicesMutation, CreateManyChoicesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateManyChoicesMutation, CreateManyChoicesMutationVariables>(CreateManyChoicesDocument, options);
      }
export type CreateManyChoicesMutationHookResult = ReturnType<typeof useCreateManyChoicesMutation>;
export type CreateManyChoicesMutationResult = Apollo.MutationResult<CreateManyChoicesMutation>;
export type CreateManyChoicesMutationOptions = Apollo.BaseMutationOptions<CreateManyChoicesMutation, CreateManyChoicesMutationVariables>;
export const ChoicesDocument = /*#__PURE__*/ gql`
    query choices($where: ChoiceWhereInput, $orderBy: [ChoiceOrderByWithRelationInput!], $cursor: ChoiceWhereUniqueInput, $take: Int, $skip: Int, $distinct: [ChoiceScalarFieldEnum!]) {
  choices(
    where: $where
    orderBy: $orderBy
    cursor: $cursor
 ...
 * });
 */
export function useChoicesQuery(baseOptions?: Apollo.QueryHookOptions<ChoicesQuery, ChoicesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ChoicesQuery, ChoicesQueryVariables>(ChoicesDocument, options);
      }
export function useChoicesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ChoicesQuery, ChoicesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ChoicesQuery, ChoicesQueryVariables>(ChoicesDocument, options);
        }
...
export type ChoicesQueryResult = Apollo.QueryResult<ChoicesQuery, ChoicesQueryVariables>;
export const CreateUserStoryDocument = /*#__PURE__*/ gql`
  ...
  createUserStory(createUserStoryInput: $createUserStoryInput) {
    ...
    `;
export type CreateUserStoryMutationFn = Apollo.MutationFunction<CreateUserStoryMutation, CreateUserStoryMutationVariables>;
 ...
 * });
 */
export function useCreateUserStoryMutation(baseOptions?: Apollo.MutationHookOptions<CreateUserStoryMutation, CreateUserStoryMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateUserStoryMutation, CreateUserStoryMutationVariables>(CreateUserStoryDocument, options);
      }
export type CreateUserStoryMutationHookResult = ReturnType<typeof useCreateUserStoryMutation>;
export type CreateUserStoryMutationResult = Apollo.MutationResult<CreateUserStoryMutation>;
export type CreateUserStoryMutationOptions = Apollo.BaseMutationOptions<CreateUserStoryMutation, CreateUserStoryMutationVariables>;
export const RemoveUserStoryDocument = /*#__PURE__*/ gql`
  ...
  removeUserStory(where: $where) {
    ...
    `;
export type RemoveUserStoryMutationFn = Apollo.MutationFunction<RemoveUserStoryMutation, RemoveUserStoryMutationVariables>;
 ...
 * });
 */
export function useRemoveUserStoryMutation(baseOptions?: Apollo.MutationHookOptions<RemoveUserStoryMutation, RemoveUserStoryMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveUserStoryMutation, RemoveUserStoryMutationVariables>(RemoveUserStoryDocument, options);
      }
export type RemoveUserStoryMutationHookResult = ReturnType<typeof useRemoveUserStoryMutation>;
export type RemoveUserStoryMutationResult = Apollo.MutationResult<RemoveUserStoryMutation>;
export type RemoveUserStoryMutationOptions = Apollo.BaseMutationOptions<RemoveUserStoryMutation, RemoveUserStoryMutationVariables>;
export const UserStoriesDocument = /*#__PURE__*/ gql`
    query userStories($uid: String!, $distinct: [UserStoryScalarFieldEnum!], $skip: Int, $take: Int, $cursor: UserStoryWhereUniqueInput, $orderBy: [UserStoryOrderByWithRelationInput!], $where: UserStoryWhereInput) {
  userStories(
    uid: $uid
    distinct: $distinct
    skip: $skip
 ...
 * });
 */
export function useUserStoriesQuery(baseOptions: Apollo.QueryHookOptions<UserStoriesQuery, UserStoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useUserStoriesCountQuery(baseOptions: Apollo.QueryHookOptions<UserStoriesCountQuery, UserStoriesCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UserStoriesCountQuery, UserStoriesCountQueryVariables>(UserStoriesCountDocument, options);
      }
export function useUserStoriesCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserStoriesCountQuery, UserStoriesCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UserStoriesCountQuery, UserStoriesCountQueryVariables>(UserStoriesCountDocument, options);
        }
export type UserStoriesCountQueryHookResult = ReturnType<typeof useUserStoriesCountQuery>;
export type UserStoriesCountLazyQueryHookResult = ReturnType<typeof useUserStoriesCountLazyQuery>;
export type UserStoriesCountQueryResult = Apollo.QueryResult<UserStoriesCountQuery, UserStoriesCountQueryVariables>;
 ...
 * });
 */
export function useUserStoryQuery(baseOptions?: Apollo.QueryHookOptions<UserStoryQuery, UserStoryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UserStoryQuery, UserStoryQueryVariables>(UserStoryDocument, options);
      }
export function useUserStoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserStoryQuery, UserStoryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UserStoryQuery, UserStoryQueryVariables>(UserStoryDocument, options);
        }
export type UserStoryQueryHookResult = ReturnType<typeof useUserStoryQuery>;
export type UserStoryLazyQueryHookResult = ReturnType<typeof useUserStoryLazyQuery>;
export type UserStoryQueryResult = Apollo.QueryResult<UserStoryQuery, UserStoryQueryVariables>;